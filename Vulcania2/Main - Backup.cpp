...
int main()
{
	...
	sf::String menuNewGame = "New Game";
	sf::Text textNewGame(menuNewGame, fontNoodle, 40);
	textNewGame.setColor(sf::Color(255, 255, 255));
	textNewGame.setPosition(343, 210);

	sf::String menuContinueGame = "Continue Game";
	sf::Text textContinueGame(menuContinueGame, fontNoodle, 40);
	textContinueGame.setColor(sf::Color(255, 255, 255));
	textContinueGame.setPosition(313.5, 210);

	sf::String menuOptions = "Options";
	sf::Text textOptions(menuOptions, fontNoodle, 40);
	textOptions.setColor(sf::Color(255, 255, 255));
	textOptions.setPosition(353.5, 260);

	sf::String menuQuit = "Quit";
	sf::Text textQuit(menuQuit, fontNoodle, 40);
	textQuit.setColor(sf::Color(255, 255, 255));
	textQuit.setPosition(374.5, 310);

	sf::String menuVersion = "Version: " + Version;
	sf::Text textMenuVersion(menuVersion, fontNoodle, 20);
	...
	while (Window.isOpen())
	{
		...
		while (Window.pollEvent(Event))
		{
			if (gamestate == MainMenu)
			{
				...
				{
					if (menu.Option == menu.optionOptions)
					{
					...
					else if (menu.Option == menu.optionQuit)
					{
						...
						menu.Option = menu.optionOptions;
					}
				}
				else if (sf::Keyboard::isKeyPressed(sf::Keyboard::Down))
				{
					...
					else if (menu.Option == menu.optionOptions)
					{
						textOptions.setColor(sf::Color(255, 255, 255));
						textQuit.setColor(sf::Color(204, 204, 0));
						menu.Option = menu.optionQuit;
					}
				}
			}
			...
			else if (gamestate == MainMenu)
			{
				if (sf::Keyboard::isKeyPressed(sf::Keyboard::Return))
				{
					...
					//else if(menuOption == optionOptions)
					else if (menu.Option == menu.optionQuit)
					{
						Window.close();
					}
